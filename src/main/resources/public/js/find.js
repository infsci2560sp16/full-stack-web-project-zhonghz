    ...
    success: function (result) {
      ...
      for (var i = 0; i < members.length; i++) {
        if (i%2 !== 0) {
          ...
          // $("div#members").html("<div class="edemo"><img class="userPic" src="images/userpic.jpg" alt="userpic" width="60" height="60" /><h4>Username+car[0]</h4><br/><p>Native Language</p><p>Practise Language</p><span class="time">Last Login Date</span></div>");
        } else {
